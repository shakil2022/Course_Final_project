...
<body>
     ...
     <div class="mainpart">
          ...
          <div class="infocard">
               <h1>The Muffin Room</h1>

               <a href="../order/disp.php" rel="">
                    <div class="cardspecific" style="width: 26%;">
                        Cake Orders
                         <div class="number">
                              <?php
                              include 'connection.php';
                              $sql = "select count(*) as total from cake_order";
               ...
               <a href="../Available cakes/disp.php" rel="">
                    <div class="cardspecific" style="width: 26%;">
                         Available Cakes
                         ...
                         <div class="number">
                              <?php
                               include 'connection.php';
                              $sql = "select sum(available_piece) as total from available_cakes";
                              $result = mysqli_query($conn, $sql);
                              $data = mysqli_fetch_assoc($result);
                              echo $data['total'];
                              ?>
